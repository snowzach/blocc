...
func init() {
	...
	config.SetDefault("extractor.btc.blocks_request_timeout", "120m")
	config.SetDefault("extractor.btc.block_monitor_lifetime", "10m")
	config.SetDefault("extractor.btc.block_monitor_timeout", "20m")
